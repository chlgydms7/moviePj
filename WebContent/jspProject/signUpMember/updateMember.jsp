...
<script type="text/javascript">
	...
	function sendIt(){
		...
		f.action = "<%=cp%>/movie/updated_ok.do";
		alert("정보수정 완료");
		f.submit();
...
<br><br>
	...
	<div class="container">
		<section id="about">
			<div class="row" style="height: 100px; margin-left: 280px;"">
				...
				<p style="font-size: 30px; margin-left: -100px;" align="left"><b>CGV+CJ ONE 통합회원 정보수정</b></p>
				</div>
			</div>
		</section>
 ...
 <c:set var = "userId" value="${sessionScope.customInfo.userId }"></c:set>
		...
		<div id="bbsCreated">
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					<dt> 이&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;름</dt>
					<dd>
						<input type="text" name="userName" value="${dto.userName }" size="35" maxlength="50" class="boxTF" style="height: 40px;border-color: #EAEAEA;border-style: solid;" readonly/>
					</dd>
				</dl>
			</div>
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					<dt> 아&nbsp;이&nbsp;디</dt>
					<dd>
						<input type="text" name="userId" value="${userId }" size="35" maxlength="20" class="boxTF" style="height: 40px; border-color: #EAEAEA;border-style: solid;" readonly/>
					</dd>
				</dl>
			</div>
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					<dt> 패스워드</dt>
					<dd>
						<input type="password" name="userPwd" value="${dto.userPwd }" size="35" maxlength="20" class="boxTF" style="height: 40px;border-color: #EAEAEA;border-style: solid;"/>
					</dd>
				</dl>
			</div>
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					<dt> 생년월일</dt>
					<dd>
						<input type="text" name="userBirth" value="${dto.userBirth }" size="35" maxlength="50" class="boxTF" style="height: 40px;border-color: #EAEAEA;border-style: solid;" aria-label="&nbsp;&nbsp;&nbsp;YYYY-MM-DD"/>
					</dd>
				</dl>
			</div>
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					<dt> 휴대전화</dt>
					<dd>
						<input type="text" name="userTel" value="${dto.userTel }" size="35" maxlength="50" class="boxTF" style="height: 40px;border-color: #EAEAEA;border-style: solid;"/>
					</dd>
				</dl>
			</div>
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					<dt> 이메일</dt>
					<dd>
						<input type="text" name="userEmail" value="${dto.userEmail }" size="35" maxlength="50" class="boxTF" style="height: 40px;border-color: #EAEAEA;border-style: solid;"/>
					</dd>
				</dl>
			</div>
	...
	<div id="bbsCreated_footer" style="margin-left: 0px; padding-left: 380px;">
			...
			<input type="button" value="돌아가기" class="btn btn-primary"  onclick="javascript:location.href='<%=cp%>/movie/main.do';"/>
